...
export function AppleIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" fill="currentColor" {...props}>
      <path d="M17.05 12.54c-.02-2.27 1.85-3.37 1.94-3.43a4.16 4.16 0 0 0-3.27-1.77c-1.38-.15-2.72.83-3.42.83-.72 0-1.8-.81-2.97-.78a4.34 4.34 0 0 0-3.65 2.23c-1.58 2.73-.4 6.75 1.11 8.96.76 1.08 1.65 2.29 2.82 2.25 1.14-.05 1.57-.72 2.94-.72 1.36 0 1.76.72 2.95.69 1.23-.02 2-1.08 2.73-2.17a8.94 8.94 0 0 0 1.25-2.55 3.91 3.91 0 0 1-2.43-3.54ZM14.82 5.88a3.98 3.98 0 0 0 .91-2.86 4.07 4.07 0 0 0-2.64 1.36 3.8 3.8 0 0 0-.94 2.75 3.36 3.36 0 0 0 2.67-1.25Z" />
    </svg>
  );
}
